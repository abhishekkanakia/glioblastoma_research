...
# Exclude ATRX and IDH2 due to zero instances from Step 1, exclude TERT due to N=1 boundary constraint
target_genes = ["EGFR", "TP53", "IDH1", "BRAF"]
...
cox_results_df.to_csv("step3_hazard_ratios_table.csv", index=False)
...
plt.tight_layout()
plt.savefig("cox_survival_forest_plot.png", dpi=300)
plt.show()
