...
mutations_df = pd.read_excel("../../../gbm_tcga_pub2013/core_data_subset/data_mutations.xlsx")
clinical_df = pd.read_excel("../../../gbm_tcga_pub2013/core_data_subset/data_clinical_patient.xlsx", header = 4)
...
merged_df.to_csv("../../gbm_merged_data.csv", index=False)