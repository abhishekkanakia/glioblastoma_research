...
target_genes = ["STAG2", "IDH1", "ADAMTS12", "TEX15"]

os.makedirs("../RESULTS/propensity_plots", exist_ok=True)
iptw_records = []
...
for gene in target_genes:
    ...
    plt.tight_layout()
    plt.savefig(f"../RESULTS/propensity_plots/{gene}_overlap_plot.png", dpi=300)
    plt.close()
...
iptw_results_df.to_csv("../RESULTS/step4_iptw_results_table.csv", index=False)
